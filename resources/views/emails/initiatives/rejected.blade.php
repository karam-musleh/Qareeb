...
<head>
    ...
    <title>لم تتم الموافقة على مبادرتك | قريب</title>
...
<body>
    <div class="email-wrapper">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 18px 32px; border-bottom: 1px solid #ffe9e6;">
            <tr>
                <td class="brand-bar-td" align="right" valign="middle">
                    <div style="font-size: 20px; font-weight: 700; color: #b70011; font-family: 'IBM Plex Sans Arabic', sans-serif;">Qareeb | قريب</div>
                </td>
        ...
        <!-- Hero Section -->
        <div style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 55%, #b91c1c 100%); padding: 48px 32px; text-align: center; position: relative; overflow: hidden;">
            ...
            <div style="position: relative; z-index: 2;">
                ...
                <h1 style="color: #ffffff; font-size: 26px; font-weight: 700; margin: 0 0 8px 0; font-family: 'IBM Plex Sans Arabic', sans-serif;">نأسف، لم تتم الموافقة على مبادرتك</h1>
                <p style="color: #fecaca; font-size: 16px; margin: 0; font-family: 'IBM Plex Sans Arabic', sans-serif;">يمكنك التعديل وإعادة التقديم</p>
            </div>
        </div>
        ...
        <div style="padding: 40px 32px;">
            ...
            <p style="font-size: 18px; color: #281715; line-height: 1.8; margin: 0 0 24px 0;">
                السلام عليكم ورحمة الله وبركاته، السيد/السيدة <span style="font-weight: 700; color: #b70011;">{{ $initiative->creator->name }}</span>، نشكرك على تقديم مبادرتك، وبعد المراجعة لم نتمكن من قبولها في الوقت الحالي.
            </p>

            <!-- Initiative Badge Card -->
            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fff0ee; border-right: 4px solid #b70011; border-radius: 12px; padding: 20px; margin: 24px 0;">
                <tr>
                    ...
                    <td valign="middle" style="padding-right: 16px; text-align: right;">
                        <div style="font-size: 10px; color: #b70011; font-weight: 700; letter-spacing: 0.8px; margin-bottom: 4px;">المبادرة المقدمة</div>
                    ...
                    <td valign="middle" align="left">
                        <div style="background-color: #fee2e2; color: #991b1b; padding: 6px 14px; border-radius: 9999px; font-size: 13px; font-weight: 700; display: inline-block;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="middle">
                                        <span class="material-symbols-outlined" style="font-size: 16px; color: #991b1b; display: block;">cancel</span>
                                    </td>
            ...
            @if ($rejectionReason)
                <div style="background-color: rgba(255, 218, 214, 0.3); border-right: 4px solid #b70011; padding: 20px; border-radius: 8px; margin: 24px 0; text-align: right;">
            ...
            <p style="font-size: 16px; color: #5c403c; line-height: 1.6; margin: 0 0 32px 0;">
                نحن نشجعك على إجراء التعديلات اللازمة وإعادة تقديم المبادرة للمراجعة مرة أخرى.
            </p>

            <!-- CTA -->
            <div style="text-align: center; margin: 32px 0 24px 0;">
                <a href="{{ config('app.frontend_url') }}/initiatives/{{ $initiative->slug }}/edit" class="cta-btn" style="display: inline-block; background-color: #dc2626; color: #ffffff; padding: 14px 44px; border-radius: 12px; font-weight: 700; font-size: 18px; text-decoration: none; box-shadow: 0 6px 20px rgba(220, 38, 38, 0.25); transition: background-color 0.2s, box-shadow 0.2s;">
